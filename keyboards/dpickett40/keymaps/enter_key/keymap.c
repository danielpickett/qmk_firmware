...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		KC_ESC, KC_EXLM, KC_AT, KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, KC_HOME, KC_UP, KC_END, KC_PPLS, KC_BSPC,
		KC_TRNS, KC_AMPR, KC_ASTR, KC_DLR, KC_PERC, KC_LCBR, KC_RCBR, KC_LEFT, KC_DOWN, KC_RGHT, KC_QUOT, KC_EQL,
