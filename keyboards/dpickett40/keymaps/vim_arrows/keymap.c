...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		KC_TRNS,    KC_EXLM,    KC_AT,      KC_LPRN,   KC_RPRN,   KC_LBRC,   KC_RBRC,    S(KC_DOT),  KC_MINS,    KC_EQL,   KC_PPLS,     KC_DEL,
		KC_TRNS,    KC_AMPR,    KC_ASTR,    KC_DLR,    KC_PERC,   KC_LCBR,   KC_RCBR,    KC_LEFT,    KC_UP,      KC_DOWN,  KC_RGHT,     KC_ENTER,
...
// flash command ------------------------------------> make dpickett40:default:avrdude <--------------------------------------------
