...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LSFT,    KC_Z,       KC_X,       KC_C,      KC_V,      KC_B,                             KC_N,       KC_M,       KC_COMM,    KC_DOT,   KC_SLSH,     KC_RSFT,
		                                    KC_LALT,   KC_LGUI,   KC_RCTRL,                         MO(1),      KC_SPC,     MO(3)),
                       
	KEYMAP(                       
		KC_TRNS,    KC_EXLM,    KC_AT,      KC_LPRN,   KC_RPRN,   KC_LBRC,                          KC_RBRC,    S(KC_DOT),  KC_UP,      KC_EQL,   KC_PPLS,     KC_BSPC,
		KC_TRNS,    KC_AMPR,    KC_ASTR,    KC_DLR,    KC_PERC,   KC_LCBR,                          KC_RCBR,    KC_LEFT,    KC_DOWN,    KC_RGHT,  KC_MINS,     KC_ENTER,
	...
	KEYMAP(                       
		...
		KC_TRNS,    KC_AMPR,    KC_ASTR,    KC_DLR,    KC_PERC,   KC_LCBR,                          KC_RCBR,    KC_4,       KC_5,       KC_6,     KC_MINS,     KC_ENTER,
		KC_TRNS,    KC_F23,     KC_F24,     KC_CIRC,   KC_HASH,   KC_NO,                            KC_NO,      KC_1,       KC_2,       KC_3,     KC_DOT,      KC_TRNS,
	...
	KEYMAP(                       
		...
		KC_TRNS,    KC_NO,      KC_NO,      KC_NO,     KC_NO,     KC_NO,                            KC_NO,      KC_LEFT,    KC_DOWN,    KC_RGHT,  KC_F11,      KC_TRNS,
		KC_TRNS,    KC_F1,      KC_F2,      KC_F3,     KC_F4,     KC_F5,                            KC_F6,      KC_F7,      KC_F8,      KC_F9,    KC_F10,      G(C(KC_Q)),
		                                    KC_TRNS,   KC_TRNS,   KC_TRNS,                          KC_MPLY,    KC_MPLY,    KC_TRNS)
};


// flash command ------------------------------------> make dpickett40s:default:avrdude <--------------------------------------------
