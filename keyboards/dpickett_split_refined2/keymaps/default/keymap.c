...
// flash command ------------------------------------> make dpickett_split_refined2:default:flash <--------------------------------------------
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		MO(2), 			KC_Q, 			KC_W,  			KC_E, 			KC_R, 			KC_T, 		KC_Y, 			KC_U, 			KC_I, 			KC_O, 		KC_P, 			KC_DEL, 
	...
	KEYMAP(
		...
		KC_TRNS,    KC_GRV,     KC_F24,     KC_CIRC,   	KC_HASH,   KC_NO,   KC_NO,      S(KC_TAB),  KC_GRV,     KC_TAB,   KC_BSLS,     KC_TRNS,
  ...
  // LAYER 2
	KEYMAP(
		...
		KC_TRNS,    KC_GRV,     KC_F24,     KC_CIRC,   	KC_HASH,   KC_NO,     KC_0,       KC_1,       KC_2,       KC_3,     KC_DOT,      KC_TRNS,
